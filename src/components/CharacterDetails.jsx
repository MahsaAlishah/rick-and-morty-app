...
function CharacterDetails({ selectedId, onAddFavourite, isAddFavourite }) {
  ...
  return (
    <div style={{ flex: 1 }}>
      <CharacterSubInfo character={character} onAddFavourite={onAddFavourite} isAddFavourite={isAddFavourite} />
...
function CharacterSubInfo({ character, isAddFavourite, onAddFavourite }) {
  return (
    <div className="character-detail">
      ...
      <div className="character-detail__info">
        ...
        <div className="actions">
          {isAddFavourite ? (
            <p>This character is already added to favourites👌</p>
          ) : (
            <button className="badge badge--secondary" onClick={() => onAddFavourite(character)}>
              Add to Favorites
            </button>
          )}
        </div>
